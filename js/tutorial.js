...
void main(void)
{
  float l0 = 0.7 * cnoise( 5.0 * vUv);
  float l1 = 0.4 * cnoise( 20.0 * vUv);
  float l2 = 0.04 * cnoise( 10000.0 * vUv);
...
shader_material = new THREE.ShaderMaterial({uniforms: {}, vertexShader: vertex_shader, fragmentShader: frag_shader});
